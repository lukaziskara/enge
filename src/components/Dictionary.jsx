...
export default function Dictionary(props) {
  ...
  console.log(cardsData.wordsForLeft);
  return (
    <>
      <div className="dictionary">
        <div className="t_words flex_wrap">
          {cardsData.wordsForLeft.map(
            (cardData, index) => (
              <div
                className={
                ...
                onClick={() => {
                  ...
                  if (leftBack.current === rightBack.current) {
                    ...
                    cardsData.wordsForLeft.splice(frontTextId.current, 1);
                    cardsData.wordsForRight.splice(backTextId.current, 1);
        ...
        <div className="b_words flex_wrap">
          {cardsData.wordsForRight.map((cardData, index) => (
            <div
              className={
